...
Librerías a instalar previamente:
pip install pipenv

Para el Hito-3, en adelante, se implementó una BD en MySql, la que se puede crear instalando la última versión de esta
...
Para cargar imágenes crear un super usuario en django y subirlas mediante el admin de django.  
